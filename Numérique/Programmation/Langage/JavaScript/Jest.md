...
description: 
published: true
date: 2024-06-09T23:07:01.447Z
tags: 
editor: markdown
dateCreated: 2024-06-09T23:07:01.447Z
---
...
module.exports = {
  ...
  testEnvironment: 'node', // pour TypeScript
...
Si vous avez configurer l'option `script` pour executer les tests avec la commande de test :
...
Configuration pour utiliser le preset `ts-jest` & `jest-puppeteer` :
...
Ajouter dans le fichier de configuration `jest.config.js` :
...
let jest_puppeteer_conf = {
    launch: {
        timeout: 30000,
        headless: "new",
        executablePath: '/path/to/bin/chromium'
    }
}
